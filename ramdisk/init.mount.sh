...
mount -t f2fs -o rw,noatime,nodiratime,background_gc=on,discard /dev/block/platform/msm_sdcc.1/by-name/cache /cache
mount -t ext4 -o rw,noatime,nodiratime,data=ordered,barrier=1,discard /dev/block/platform/msm_sdcc.1/by-name/userdata /data
mount -t f2fs -o rw,noatime,nodiratime,background_gc=on,discard /dev/block/platform/msm_sdcc.1/by-name/userdata /data
